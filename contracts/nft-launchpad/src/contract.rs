...
pub fn instantiate(
    ...
    // If the random_seed is empty, we will set RANDOM_SEED to [0u8; 32]
    // And in that case, the token_id of each NFT will be generated by incrementing the launchpad_info.total_supply
...
pub fn mint(
    ...
    for _ in 0..amount_nfts {
        ...
        // generate token_id
        let token_id = if random_seed != [0u8; 32] {
            generate_random_token_id(
                deps.storage,
                current_time,
